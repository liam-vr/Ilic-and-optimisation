"""
Evolve dynamics in Frame M using the full, non-linear equations of motion
"""
...
################################
## Load the lookup tables for the grating
grating_type = "Ilic"
...
if grating_type == "Ilic":
    ...
    klambda = 1000
    kdelta = 1000
    pkl_load_name = rf"./Lookup_tables/Ilic-10_Lookup_table_lambda_{klambda}_by_delta_{kdelta}.pkl"

if grating_type == "Ilic-damp":
    ## Data for stable Ilic, w=2.718
    klambda = 1000
    kdelta = 1000
    pkl_load_name = rf"./Lookup_tables/Ilic-damp_Lookup_table_lambda_{klambda}_by_delta_{kdelta}.pkl"
...
###############
## For Ilic-10%c (mixed stability, w=2)
...
## runID: 2 - case (b)
# y0      = -(50/100) * L 
# phi0    =   -np.arctan(10/100)
# vy0     =   0
# omega0  =   0

###############
## For Ilic-damp (stable region, w= 2.718)

## runID: 1
# y0      =   5.345753475058606e-10
# phi0    =   3.061587515290477e-09
# vy0     =   -1.9204486790123356
# omega0  =   -0.558424134413175

## runID: 2
# y0      =   -1.3266038044024307e-07
# phi0    =   -8.337125305810491e-09
# vy0     =   1.999653228985437
# omega0  =   0.02692249228938459
...
## Save result
if grating_type == 'Ilic':
    pkl_fname = f'./Data/Ilic-10/Dynamics_run{runID}_I{I_string}.pkl'
if grating_type == 'Ilic-damp':
    pkl_fname = f'./Data/Ilic-damp/Dynamics_run{runID}_I{I_string}.pkl'
