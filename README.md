...
$\begin{aligned}
    ...
    \mu^y_y&=-D^2 \frac{I_0}{mc} \frac{1}{c} \frac{D+1}{D(\gamma+1)} \left[ Q^{R'}_{\text{pr,1}} + Q^{L'}_{\text{pr,1}} + \frac{\p Q^{R'}_{\text{pr,2}}}{\p \delta'} + \frac{\p Q^{L'}_{\text{pr,2}}}{\p \delta'} \right](0, \lambda')
    \, \frac{w}{2} \sqrt{\frac{\pi}{2}} \erf\left[\frac{1}{\bar{w} \sqrt{2}} \right],  \\
